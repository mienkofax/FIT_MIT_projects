function BSPLINE(canvas1id, canvas2id, scale, n, k, ptX, ptY, ptW, pt){
	var ptWtmp = ptW;
	...
	cmp = document.getElementById("cmp3");
...
novyB = document.getElementById("novy-bod");
novyB.addEventListener('click', addPointInto);

removeP = document.getElementById("odstranit-bod");
...
zob2 = document.getElementById("zobrazit2");
zob2.addEventListener('change', zobraz);

function zobraz()
{
	zobrazit = zob2.checked;
	drawFun();
	drawSpline();

	console.log(zob2.checked);
}

function compare2(ev) {
	var data = document.getElementById("bspline-acc").getElementsByClassName("in")[0].getElementsByClassName("data")[0];
