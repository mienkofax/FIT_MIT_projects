 ...
 *  Úprava: Bohuslav Křena, říjen 2009
 */
 ...
 * Při hodnocení však budou pouľity rozšířené testy, které se zaměří
 * i na okrajové situace. Doporučujeme proto, aby si kaľdý student
...
int main(int argc, char *argv[])	{
    ...
    printf("\n[TEST17]\n");
    printf("Operace DLPreDelete nyní smaľe první prvek.\n");
    printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    test_DLPreDelete();
    test_DLActive();
