 ...
 *******************************************************************************
 * V tomto příkladu jsme pouľili trochu více angličtinu neľ obvykle.
 * Máme pro to dva důvody:
 *
 * 1) Angličtina je druhá mateřština informatika! Bez ní se jako informatici
 * (a v dnešní době nejenom jako informatici) asi jenom těľko obejdete.
 * Domácí úlohy (alespoň z části) v angličtině by vám proto mohli pomoci při
 * zaľití tohoto jazyka. Pojmenovávat identifikátory anglickými termíny je
 * velice dobrý zvyk - nikdy nevíte, zda Váš kód nebude později číst nebo
 * dokonce upravovat někdo, kdo česky nerozumí. Stejně tak je uľitečné psát
 * anglictky i komentáře.
 *
 * 2) Na FIT přijíľdějí zahraniční studenti v rámci projektů ERASMUS/SOCRATES
 * Aby se podmínky jejich studia co nejvíce blíľily podmínkám, které mají
 * studenti studující v češtině, měli by zahraniční studenti dělat i stejné
 * domácí úlohy. Jenľe to vyľaduje mít domácí úlohy připraveny v angličtině.
 * A udrľovat konzistenci dvou verzí domácích úloh (českých a anglických)
 ...
 * nemohl cítit poškozen tím, ľe zadání nerozuměl právě kvůli pouľití
 * nemateřského jazyka.
 ******************************************************************************/
